...
using CleanArchitecture90120231201.UseCases.Contributors.Update;
using MediatR;
using Ardalis.Result;
using CleanArchitecture90120231201.UseCases.Contributors.Get;

namespace CleanArchitecture90120231201.Web.ContributorEndpoints;
