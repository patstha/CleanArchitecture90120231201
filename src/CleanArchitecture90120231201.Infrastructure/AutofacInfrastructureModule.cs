...
using CleanArchitecture90120231201.Core.Interfaces;
using CleanArchitecture90120231201.Infrastructure.Data;
using CleanArchitecture90120231201.Infrastructure.Data.Queries;
using CleanArchitecture90120231201.Infrastructure.Email;
using CleanArchitecture90120231201.UseCases.Contributors.Create;
using CleanArchitecture90120231201.UseCases.Contributors.List;
using MediatR;
using MediatR.Pipeline;
using Module = Autofac.Module;

namespace CleanArchitecture90120231201.Infrastructure;
